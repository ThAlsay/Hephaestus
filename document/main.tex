...
\begin{document}
	...
	\mainmatter
		\include{tex_files/mainmatter/chapter_1/introduccion}
		\include{tex_files/mainmatter/chapter_2/planificacion}
		\include{tex_files/mainmatter/chapter_3/estado_arte}
		\include{tex_files/mainmatter/chapter_4/analisis}
		\include{tex_files/mainmatter/chapter_5/diseno}
		\include{tex_files/mainmatter/chapter_6/pruebas}
		\include{tex_files/mainmatter/chapter_7/conclusion}
		
		\appendix\setcounter{chapter}{0}
		\include{tex_files/backmatter/appendix_a}
		\include{tex_files/backmatter/appendix_b}

...
Una vez se han determinado los requisitos de esta parte del proyecto, se acotan los casos de uso a implementar durante el transcurso de todo el proyecto. El diagrama \ref{fig:chap4_motor_casos_uso} muestra los casos de uso del motor Hephaestus. Gracias a los casos de uso se puede tomar un métrica del estado del proyecto, si todos los casos de uso están implementados este se puede dar por finalizado.

\begin{figure}[h]
	\centering
	\includegraphics[width=0.9\textwidth]{tex_files/mainmatter/chapter_4/images/diagrama_analisis_motor/casos_uso_motor.png}
	\caption{Diagrama de casos de uso de Hephaestus}
	\label{fig:chap4_motor_casos_uso}
\end{figure}

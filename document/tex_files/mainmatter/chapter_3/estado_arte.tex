...
Aunque una idea sea original existen otros muchos trabajos que pueden servir para aportar nuevas ideas que complementen a la original, encontrar soluciones a problemas que pueda llegar a tener el proyecto o simplemente afianzar la idea inicial al ver otro proyecto que comparte un concepto que se va a emplear en el nuevo. La construcción del proyecto depende enteramente de las tecnologías que lo conforman, sin estas el proyecto no tendría entidad y solamente existiría como concepto abstracto.

\section{Antecedentes}

Dado que el foco principal del proyecto es el motor de videojuegos distribuidos Hephaestus, el foco de la investigación inicial es la búsqueda de otros ejemplos de videojuegos distribuidos y, por lo tanto, que cuenten con un motor distribuido. Teniendo esto en cuenta, es también importante adquirir nociones básicas de desarrollo de videojuegos y de videojuegos de rol ya que el juego didáctico forma parte de esta categoría.

\subsection{Second Life}

Second Life es un mundo virtual multijugador que permite a los usuarios crearse un avatar para ellos mismos e interactuar a través del avatar con otros usuarios y con el contenido creado por estos. Fue lanzado en junio de 2003 por la compañía Linden Lab. Se puede acceder al mundo virtual mediante el cliente software propio de la empresa o mediante clientes creados por terceros, ya que la tecnología del cliente es de código abierto.
...
\subsection{Design patterns of successful role-playing games}

\textit{Design patterns of successful role-playing games} es un documento publicado por Whitson John Kirk III en el año 2006 en el cual ahonda en el diseño de juegos de rol. En este caso el estudio realizado por Kirk no se centra únicamente en los videojuegos sino que profundiza en todas las mecánicas que puedan ser de utilidad a la hora de diseñar un juego de rol en cualquier formato, físico o virtual \cite{kirk2006design}.

El nivel de profundidad que llega a tener este estudio sobrepasa por mucho el objetivo de este proyecto y, en concreto, la complejidad del juego didáctico diseñado en el mismo. Pero, aún así, el documento concentra en un mismo lugar todos los elementos que conforman un juego de rol, facilitando el diseño del juego didáctico y aportando ideas nuevas que podrían pasar desapercibidas de otra forma.
...
Es un lenguaje basado en Erlang \cite{erlang} y emplea la misma máquina virtual que este. De esta manera se puede hacer uso de bibliotecas originalmente pensadas para Erlang desde el propio Elixir de forma nativa. Además, Elixir ofrece otra serie de características, algunas de ellas heredadas de Erlang, que lo siguen posicionando como un lenguaje muy interesante para el desarrollo de sistemas distribuidos y desarrollo web:
...
La máquina virtual sobre la que la se ejecuta el código Elixir se conoce como BEAM. Surge con el nacimiento de Erlang y permite a este lenguaje de programación, y también a Elixir, aprovechar varias de sus características. Ya se ha mencionado la característica distribuida de la máquina virtual, gracias a sus procesos ligeros y aislados. Además de esta característica, la máquina virtual ofrece otras dos características que aumentan el interés por el empleo de Elixir para este proyecto.
...
Además, Docsify presenta varios temas para personalizar la página web generada al gusto del creador e incluye, por defecto, varios elementos imprescindibles en una página dedicada a la documentación como pueden ser las barras de navegación.

La elección de Docsify para el proyecto surge de la necesidad de crear una página web estática, requisito imprescindible para poder ser alojada en GitHub Pages. El empleo de otras tecnologías web, como puede ser Angular, suponía el empleo del sistema de CI/CD de GitHub para poder ser desplegados. Por lo tanto, la elección más lógica significa emplear Docsify, por su despliegue inmediato y su sencillez a la hora de desarrollar la documentación. 
